...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("Welcome To Pen-EDIT")
    # Creating Menubar
  ...
  def saveasfile(self,*args):
    ...
    try:
      ...
      untitledfile = filedialog.asksaveasfilename(title = "Save file As",defaultextension=".txt",initialfile = "Untitled.txt",filetypes = (("All Files","*.*"),("Text Files","*.txt"),("Python Files","*.py"),("Lua Files","*.lua")))
      # Reading the data from text area
      data = self.txtarea.get("1.0",END)
      # opening File in write mode
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","Pen-EDIT is a simple text editor included with the Pen-OS")
